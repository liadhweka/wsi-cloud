...
destroys and reapplies.** If preflight complains about the living handoff's `Written:` date: the two Leg-B
rebuilds deliberately use tmp/ prompts instead of editing Leg A's live handoff (ratified 2026-08-20) —
surface the warning, do not edit `prompts/handoff-cloud.md`.
