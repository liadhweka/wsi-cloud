...
| **Input dependency (ratified 2026-08-15)** | The full-cohort raw-TIFF this grid reads **exists at rest: 4.D converts and retains all 1073 slides** (Stage-4 register). The N=64 cell's disjoint chunks are what forced the decision — 64 processes need ≥64 slides. |
