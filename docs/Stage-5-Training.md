...
| **Aggregated output** | `../runs/s5.A-training-summary-<leg>.csv` — the aggregator rolls 5.A and 5.B cells into that one file, tagged by a `substage` column |
