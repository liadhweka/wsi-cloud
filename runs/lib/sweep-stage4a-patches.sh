...
# 50-slide random subset per dataset (seed=42, see runs/manifests/<dataset>-stage4a-subset.tsv).
...
#
# Usage:
#   runs/lib/sweep-stage4a-patches.sh                # default {64 8 1}
#   runs/lib/sweep-stage4a-patches.sh 64             # phase 1: just n=64 cells (~10 min)
#   runs/lib/sweep-stage4a-patches.sh 8 1            # phase 2: chain n=8 then n=1 (~9 hr)
#
# Output:
...
log "next:    runs/lib/aggregate-stage4a-patches.py 'runs/2026-*-s4.A-patches-*'"
