# 2026-08-23-063758-weka-s7-7.4.b-read-after-write

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** 7.4  ·  **Started (UTC):** 2026-08-23T06:38:01Z
...
```
/data/local-nvme/conda-envs/wsi-cucim-2604/bin/python scripts/read-after-write-stage7.py --output-dir /mnt/weka/heatmaps/7.4b --n-slides 20 --bytes-per-write 6440000 --poll-interval-s 0.001 --per-slide-csv /home/ec2-user/wsi-cloud/runs/2026-08-23-063758-weka-s7-7.4.b-read-after-write/read-after-write-latencies.csv --summary-json /home/ec2-user/wsi-cloud/runs/2026-08-23-063758-weka-s7-7.4.b-read-after-write/raw-summary.json 
```

## Why this run exists

Stage 7.4.b read-after-write consistency — 20 writes of MEASURED-7.3-matched heatmaps; 1ms polling reader (resolution floor recorded). ARTIFACT MATCHED AND NOW DETERMINISTIC: target 6,440,000 B = the mean of the 50 recorded tiff5x writes in cell 2026-08-23-033008-weka-s7-7.3.a-heatmap-tiff5x-virchow2-brca50 (median 6.19 MB); 256x256 single-level tiles, UNCOMPRESSED so achieved size is deterministic within one tile (the prior zlib pattern achieved 5.3% of target — that cell is forensic-renamed); target-vs-achieved recorded. Re-run after the writer fix.
