# 2026-08-22-083354-weka-s1.5-restage-tcga-brca-for-1.5-prep-n16

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** 1.5  ·  **Started (UTC):** 2026-08-22T08:33:57Z
...
```
fpsync -v -n 16 -d /tmp/fpsync-prep /mnt/weka/data/tcga-brca/ /data/local-nvme/fpsync-source/tcga-brca/ 
```
