# 2026-08-17-081158-weka-s4.B-tilesread-tcga-brca-cucim-N16-nw16-bs4-coldref

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** 4.B  ·  **Started (UTC):** 2026-08-17T08:13:45Z
...
```
env CONDA_PREFIX=/data/local-nvme/conda-envs/wsi-cucim /data/local-nvme/conda-envs/wsi-cucim/bin/python /home/ec2-user/wsi-cloud/scripts/read-tiles-onthefly.py --backend cucim --n-processes 16 --num-workers 16 --batch-size 4 --svs-dir /mnt/weka/data/tcga-brca --coords-dir /mnt/weka/tissue-detection/3.0/tcga-brca/n64/patches --runtime 60 --ramp 10 --coord-pool-pickle /data/local-nvme/stage4b-pool-cache/tcga-brca.pkl --latency-csv /tmp/stage4b-latencies/tilesread-tcga-brca-cucim-N16-nw16-bs4-coldref.csv --summary-json /tmp/stage4b-latencies/tilesread-tcga-brca-cucim-N16-nw16-bs4-coldref.summary.json --seed 42 
```
