# 2026-08-23-004037-weka-s7-7.1.f-cucim-uni2-h-warm

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** 7.1  ·  **Started (UTC):** 2026-08-23T00:40:40Z
...
```
/data/local-nvme/conda-envs/wsi-cucim-2604/bin/python /home/ec2-user/wsi-cloud/scripts/inference-per-slide-stage7.py --backend cucim_batched_cpu --model uni2-h --rawtiff-dir /mnt/weka/data/tcga-brca-rawtiff --svs-dir /mnt/weka/data/tcga-brca --coords-dir /mnt/weka/tissue-detection/3.0/tcga-brca/n64/patches --manifest /home/ec2-user/wsi-cloud/scripts/manifests/tcga-brca-stage4a-subset.tsv --heatmap-dir /mnt/weka/heatmaps/7.1/7.1.f-cucim-uni2-h-warm --heatmap-format tiff5x --inference-batch-size 256 --cache-policy warm --max-slides 50 --per-slide-csv /home/ec2-user/wsi-cloud/runs/2026-08-23-004037-weka-s7-7.1.f-cucim-uni2-h-warm/per-slide-inference-latencies.csv --per-slide-heatmap-csv /home/ec2-user/wsi-cloud/runs/2026-08-23-004037-weka-s7-7.1.f-cucim-uni2-h-warm/per-slide-heatmap-writes.csv --summary-json /home/ec2-user/wsi-cloud/runs/2026-08-23-004037-weka-s7-7.1.f-cucim-uni2-h-warm/inference-summary.json 
```

## Why this run exists

[PENDING-APPROVAL-DO-NOT-EXTERNALIZE] Stage 7 single-process inference cell: backend=cucim_batched_cpu model=uni2-h cache=warm heatmap=tiff5x N_slides=50. WHY: per-slide inference latency baseline with per-phase decomposition (tissue/extract/MIL/heatmap-write). The clinical-deployment-decisive 'T seconds per inference' customer number. Regime: warm — cache carries over across slides by design; re-inference on already-read slides is production steady-state.
