# 2026-08-17-122126-weka-s4.B-tilesread-tcga-brca-cucim-N64-nw16-bs4-rep3

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** 4.B  ·  **Started (UTC):** 2026-08-17T12:21:30Z
...
```
env CONDA_PREFIX=/data/local-nvme/conda-envs/wsi-cucim /data/local-nvme/conda-envs/wsi-cucim/bin/python /home/ec2-user/wsi-cloud/scripts/read-tiles-onthefly.py --backend cucim --n-processes 64 --num-workers 16 --batch-size 4 --svs-dir /mnt/weka/data/tcga-brca --coords-dir /mnt/weka/tissue-detection/3.0/tcga-brca/n64/patches --runtime 60 --ramp 10 --coord-pool-pickle /data/local-nvme/stage4b-pool-cache/tcga-brca.pkl --latency-csv /tmp/stage4b-latencies/tilesread-tcga-brca-cucim-N64-nw16-bs4.csv --summary-json /tmp/stage4b-latencies/tilesread-tcga-brca-cucim-N64-nw16-bs4.summary.json --seed 42 
```

## Why this run exists

Stage 4.B tier1 cell 10/26: random tile reads. Backend=cucim CPU batched. Dataset=tcga-brca. N_processes=64, num_workers=16 (cuCIM C++ thread pool), batch_size=4, prefetch_factor=2. cuCIM per-process tile cache: 512 MiB (library default; recorded-not-swept per the Stage-4 register — identical on both legs). LRU(8) slide handle cache per worker. seed=42. runtime=60s + 10s ramp. Cache arm=warm. Cell order fixed and de-ordered in N (D13). [D18 REP=3 re-invocation of 2026-08-17-080156-weka-s4.B-tilesread-tcga-brca-cucim-N64-nw16-bs4 — same command, same env; reps group to median + spread]
