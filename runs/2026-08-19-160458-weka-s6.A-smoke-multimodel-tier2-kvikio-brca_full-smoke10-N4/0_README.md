# 2026-08-19-160458-weka-s6.A-smoke-multimodel-tier2-kvikio-brca_full-smoke10-N4

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** 6.A  ·  **Started (UTC):** 2026-08-19T16:05:01Z
...
```
/home/ec2-user/wsi-cloud/scripts/run-stage6a-tier2-chunked-multimodel.sh --models virchow2\,gigapath\,uni2-h --n-gpus 4 --gpu-csv 0\,1\,2\,3 --output-dir-base /mnt/weka/features/6.A-smoke --run-dir /home/ec2-user/wsi-cloud/runs/2026-08-19-160458-weka-s6.A-smoke-multimodel-tier2-kvikio-brca_full-smoke10-N4 --chunk-size 5 --max-slides 10 
```

## Why this run exists

[PENDING-APPROVAL-DO-NOT-EXTERNALIZE] Stage 6.A Tier 2 MULTI-MODEL orchestrator SMOKE: 10 slides × 2 chunks × 3 models (virchow2/gigapath/uni2-h). Validates cross-model conversion sharing pipeline before the full Tier 2 sweep.
