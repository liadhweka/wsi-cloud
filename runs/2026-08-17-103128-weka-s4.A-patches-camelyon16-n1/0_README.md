# 2026-08-17-103128-weka-s4.A-patches-camelyon16-n1

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** 4.A  ·  **Started (UTC):** 2026-08-17T10:31:32Z
...
```
env CONDA_PREFIX=/data/local-nvme/conda-envs/wsi-cucim /data/local-nvme/conda-envs/wsi-cucim/bin/python /home/ec2-user/wsi-cloud/scripts/extract-tiles-to-hdf5.py --concurrency 1 --svs-dir /mnt/weka/data/camelyon16/images --coords-dir /mnt/weka/tissue-detection/3.0/camelyon16/n64/patches --output-dir /mnt/weka/patches/4.A/camelyon16/n1 --latency-csv /tmp/stage4a-latencies/camelyon16-n1-latencies.csv --manifest /home/ec2-user/wsi-cloud/scripts/manifests/camelyon16-stage4a-subset.tsv 
```

## Why this run exists

Stage 4.A cell 6/6: pre-extract tiles to per-slide HDF5. Dataset=camelyon16 (50-slide random subset, seed=42, manifest=/home/ec2-user/wsi-cloud/scripts/manifests/camelyon16-stage4a-subset.tsv, 50 slides), concurrency=1. Per slide: openslide.OpenSlide + read_region(level=0, 256x256) for each CLAM coord (~52K BRCA / ~11K CAMELYON16 avg per slide), JPEG-encoded q=85, written to /mnt/weka/patches/4.A/camelyon16/n1/<slide-id>.h5 with variable-length JPEG bytes dataset + coords + attrs. Single-pass. Concurrency via Python multiprocessing.Pool (per-slide-level).
