# 2026-08-22-105334-weka-s6.C-concurrent-extract+ingest

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** 6.C  ·  **Started (UTC):** 2026-08-22T10:53:37Z
...
```
/home/ec2-user/wsi-cloud/scripts/orchestrate-concurrent-stage6c.sh --workloads extract\,ingest --ramp 300 --runtime 1500 --run-dir /home/ec2-user/wsi-cloud/runs/2026-08-22-105334-weka-s6.C-concurrent-extract+ingest 
```
