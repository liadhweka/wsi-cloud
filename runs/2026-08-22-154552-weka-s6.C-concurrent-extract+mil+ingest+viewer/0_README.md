# 2026-08-22-154552-weka-s6.C-concurrent-extract+mil+ingest+viewer

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** 6.C  ·  **Started (UTC):** 2026-08-22T15:45:55Z
...
```
/home/ec2-user/wsi-cloud/scripts/orchestrate-concurrent-stage6c.sh --workloads extract\,mil\,ingest\,viewer --ramp 300 --runtime 1500 --run-dir /home/ec2-user/wsi-cloud/runs/2026-08-22-154552-weka-s6.C-concurrent-extract+mil+ingest+viewer 
```
