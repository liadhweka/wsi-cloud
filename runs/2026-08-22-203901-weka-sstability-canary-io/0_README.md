# 2026-08-22-203901-weka-sstability-canary-io

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** stability  ·  **Started (UTC):** 2026-08-22T20:39:04Z
...
```
fio --name=canary-seqread --filename=/mnt/weka/benchmarks/stability-canary/canary-io.bin --size=8G --rw=read --bs=1M --direct=1 --ioengine=libaio --iodepth=8 --runtime=60 --time_based --name=canary-randread --stonewall --filename=/mnt/weka/benchmarks/stability-canary/canary-io.bin --size=8G --rw=randread --bs=64k --direct=1 --ioengine=libaio --iodepth=16 --runtime=60 --time_based 
```

## Why this run exists

D18 stability canary (io): fio 60s seqread (1M, iodepth 8) + 60s randread (64k, iodepth 16), O_DIRECT, one fixed 8 GiB file at /mnt/weka/benchmarks/stability-canary. Fixed config by design — this cell's spread across the leg is the leg's noise band for throughput-class cells. It measures path stability, not absolute capability: O_DIRECT keeps the client cache out; the server side is consistently warm.
