# 2026-08-16-071534-weka-s1.0a-seqw-bs256k-jobs8

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** 1.0a  ·  **Started (UTC):** 2026-08-16T07:15:37Z
...
```
fio --name=seqw-bs256k-jobs8 --directory=/mnt/weka/benchmarks/fio-scratch --rw=write --bs=256k --size=4G --numjobs=8 --iodepth=1 --ioengine=libaio --direct=1 --runtime=600 --ramp_time=60 --time_based --group_reporting --unlink=1 --output-format=json+ --status-interval=1 
```

## Why this run exists

Stage 1.0a cell 18/35: sequential write, bs=256k, 8 jobs, iodepth=1, libaio --direct=1, 600s steady + 60s ramp, --unlink=1 to keep scratch clean.
