# 2026-08-18-170015-weka-s4.C-random-brca-nb16-nt16-offgds

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** 4.C  ·  **Started (UTC):** 2026-08-18T17:00:18Z
...
```
/data/local-nvme/conda-envs/wsi-cucim-2604/bin/python /home/ec2-user/wsi-cloud/scripts/read-tiles-kvikio.py --mode random --rawtiff-dir /mnt/weka/data/tcga-brca-rawtiff --manifest /home/ec2-user/wsi-cloud/scripts/manifests/tcga-brca-stage4a-subset.tsv --compat-mode off --n-buffer 16 --num-threads 16 --summary-json /home/ec2-user/wsi-cloud/runs/2026-08-18-170015-weka-s4.C-random-brca-nb16-nt16-offgds/reader-summary.json --coords-dir /mnt/weka/tissue-detection/3.0/tcga-brca/n64/patches --latency-csv /home/ec2-user/wsi-cloud/runs/2026-08-18-170015-weka-s4.C-random-brca-nb16-nt16-offgds/per-tile-latencies.csv --level 0 --runtime 60 --ramp 10 
```
