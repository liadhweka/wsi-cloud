# 2026-08-22-210218-weka-s2.0-properties-tcga-brca-n64-cold

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** 2.0  ·  **Started (UTC):** 2026-08-22T21:08:49Z
...
```
env CONDA_PREFIX=/data/local-nvme/conda-envs/wsi-cucim-2604 /data/local-nvme/conda-envs/wsi-cucim-2604/bin/python /home/ec2-user/wsi-cloud/scripts/extract-slide-properties.py --concurrency 64 --output-dir /mnt/weka/cataloging/2.0/tcga-brca/n64-cold --manifest /tmp/stage2-manifests/tcga-brca.txt --latency-csv /tmp/stage2-manifests/tcga-brca-n64-cold-latencies.csv 
```

## Why this run exists

Stage 2.0 cell 1/16: OpenSlide property extraction. Dataset=tcga-brca (1133 slides), concurrency=64, cache arm=cold (cold: vm.drop_caches=3 with recorded acknowledgment; warm: unrecorded n=64 warmup pass immediately before). Single-pass full dataset via openslide-python + multiprocessing.Pool. Headline: 'cataloged 1133 slides in X seconds at concurrency 64, cold'.
