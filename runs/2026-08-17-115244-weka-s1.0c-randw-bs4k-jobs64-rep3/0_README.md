# 2026-08-17-115244-weka-s1.0c-randw-bs4k-jobs64-rep3

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** 1.0c  ·  **Started (UTC):** 2026-08-17T11:52:47Z
...
```
fio --name=randw-bs4k-jobs64 --directory=/mnt/weka/benchmarks/fio-scratch --rw=randwrite --bs=4k --size=4G --numjobs=64 --iodepth=8 --ioengine=libaio --direct=1 --runtime=600 --ramp_time=60 --time_based --group_reporting --unlink=1 --output-format=json+ --status-interval=1 
```

## Why this run exists

Stage 1.0c cell 7/21: random write IOPS, bs=4k, 64 jobs, iodepth=8 (WEKA recipe), libaio --direct=1, 600s steady + 60s ramp, --unlink=1. [D18 REP=3 re-invocation of 2026-08-16-181410-weka-s1.0c-randw-bs4k-jobs64 — same command, same env; reps group to median + spread]
