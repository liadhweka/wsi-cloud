# 2026-08-19-154104-weka-s6.A-extract-uni2-h-kvikio-cam16-N4

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** 6.A  ·  **Started (UTC):** 2026-08-19T15:41:08Z
...
```
/data/local-nvme/conda-envs/wsi-cucim-2604/bin/python /home/ec2-user/wsi-cloud/scripts/extract-features-foundation-stage6.py --backend kvikio --world-size 4 --model uni2-h --coords-dir /mnt/weka/tissue-detection/3.0/camelyon16/n64/patches --manifest /home/ec2-user/wsi-cloud/scripts/manifests/camelyon16-stage4a-subset.tsv --output-dir /mnt/weka/features/6.A/uni2-h/cam16 --batch-size 256 --extraction-steps-csv /home/ec2-user/wsi-cloud/runs/2026-08-19-154104-weka-s6.A-extract-uni2-h-kvikio-cam16-N4/extraction-steps.csv --per-slide-csv /home/ec2-user/wsi-cloud/runs/2026-08-19-154104-weka-s6.A-extract-uni2-h-kvikio-cam16-N4/per-slide.csv --summary-json /home/ec2-user/wsi-cloud/runs/2026-08-19-154104-weka-s6.A-extract-uni2-h-kvikio-cam16-N4/extraction-summary.json --rawtiff-dir /mnt/weka/data/camelyon16-rawtiff --n-buffer 256 --num-threads 16 --compat-mode off 
```
