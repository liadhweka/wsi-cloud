# 2026-08-23-153749-weka-s1.5-fpsync-n16

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** 1.5  ·  **Started (UTC):** 2026-08-23T15:37:52Z
...
```
fpsync -v -n 16 -d /tmp/fpsync-stage1.5/n16 /data/local-nvme/fpsync-source/tcga-brca/ /mnt/weka/data/fpsync-target/n16/ 
```

## Why this run exists

Stage 1.5 fpsync sweep cell 3/4 on fs=weka: local NVMe -> /mnt/weka, fpsync -n 16. Source: /data/local-nvme/fpsync-source/tcga-brca/ (1133 files, 1158795413424 bytes). Target: /mnt/weka/data/fpsync-target/n16 (cleaned pre-cell). fpsync default partition (-f 2000 -s 4G), default rsync opts (-lptgoD -v --numeric-ids), shdir /tmp/fpsync-stage1.5/n16. Per-cell isolation via record-run.sh: any single cell failure leaves rest of sweep intact.
