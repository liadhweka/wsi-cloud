# 2026-08-18-215655-weka-s6.A-extract-virchow2-kvikio-brca50-N4

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** 6.A  ·  **Started (UTC):** 2026-08-18T21:56:58Z
...
```
/data/local-nvme/conda-envs/wsi-cucim-2604/bin/python /home/ec2-user/wsi-cloud/scripts/extract-features-foundation-stage6.py --backend kvikio --world-size 4 --model virchow2 --coords-dir /mnt/weka/tissue-detection/3.0/tcga-brca/n64/patches --manifest /home/ec2-user/wsi-cloud/scripts/manifests/tcga-brca-stage4a-subset.tsv --output-dir /mnt/weka/features/6.A/virchow2/brca50 --batch-size 256 --extraction-steps-csv /home/ec2-user/wsi-cloud/runs/2026-08-18-215655-weka-s6.A-extract-virchow2-kvikio-brca50-N4/extraction-steps.csv --per-slide-csv /home/ec2-user/wsi-cloud/runs/2026-08-18-215655-weka-s6.A-extract-virchow2-kvikio-brca50-N4/per-slide.csv --summary-json /home/ec2-user/wsi-cloud/runs/2026-08-18-215655-weka-s6.A-extract-virchow2-kvikio-brca50-N4/extraction-summary.json --rawtiff-dir /mnt/weka/data/tcga-brca-rawtiff --n-buffer 256 --num-threads 16 --compat-mode off 
```
