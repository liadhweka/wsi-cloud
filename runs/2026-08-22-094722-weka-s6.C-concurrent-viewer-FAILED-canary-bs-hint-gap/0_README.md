# 2026-08-22-094722-weka-s6.C-concurrent-viewer

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** 6.C  ·  **Started (UTC):** 2026-08-22T09:47:25Z
...
```
/home/ec2-user/wsi-cloud/scripts/orchestrate-concurrent-stage6c.sh --workloads viewer --ramp 300 --runtime 1500 --run-dir /home/ec2-user/wsi-cloud/runs/2026-08-22-094722-weka-s6.C-concurrent-viewer 
```
