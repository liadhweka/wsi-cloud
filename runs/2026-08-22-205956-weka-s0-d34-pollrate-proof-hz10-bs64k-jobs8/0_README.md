# 2026-08-22-205956-weka-s0-d34-pollrate-proof-hz10-bs64k-jobs8

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** 0  ·  **Started (UTC):** 2026-08-22T20:59:59Z
...
```
fio --name=d34proof --directory=/mnt/weka/benchmarks/fio-canary-calib --filename_format=calib.\$jobnum --size=10G --numjobs=8 --ioengine=libaio --direct=1 --iodepth=8 --rw=read --bs=64k --runtime=45 --time_based --group_reporting --output-format=json 
```

## Why this run exists

D-34 perturbation proof cell (hz=10): identical short fio config at 1 Hz vs 10 Hz recorder polling — the app-level rate must agree within noise, and _sample_interval_s must show the achieved rate. Diagnostic, never quote.
