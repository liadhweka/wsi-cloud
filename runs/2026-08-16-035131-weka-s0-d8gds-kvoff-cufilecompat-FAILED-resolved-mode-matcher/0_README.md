# 2026-08-16-035131-weka-s0-d8gds-kvoff-cufilecompat

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** 0  ·  **Started (UTC):** 2026-08-16T03:51:34Z
...
```
env LD_PRELOAD=/usr/local/cuda/targets/x86_64-linux/lib/libcufile.so.1.14.1 CUFILE_ENV_PATH_JSON=/home/ec2-user/cufile-config/cufile.json KVIKIO_COMPAT_MODE=OFF CUDA_VISIBLE_DEVICES=0 PYTHONPATH=/home/ec2-user/wsi-cloud/scripts bash -c \"/usr/local/cuda/gds/tools/gdscheck\"\ -p\;\ \"/data/local-nvme/conda-envs/wsi-cucim-2604/bin/python\"\ \"/home/ec2-user/wsi-cloud/scripts/probe-gds-phase0.py\"\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ --file\ \"/mnt/weka/benchmarks/gds-phase0/testfile.bin\"\ --kvikio-compat\ \"off\"\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ --summary-json\ \"/home/ec2-user/wsi-cloud/runs/2026-08-16-035131-weka-s0-d8gds-kvoff-cufilecompat/gds-phase0-summary.json\" 
```

## Why this run exists

D8 Phase-0 GDS determination cell: A: kvikio compat OFF + cufile allow_compat_mode=true (the standing config) — cuFile engaged, bounce permitted. Modes FORCED, never AUTO (three-layer path accounting); gdscheck -p captured in cmd.log; verdict = the recorded path_accounting split, not any config flag. Reads are backend-RAM-resident by construction — the PATH is the question, not the rate.
