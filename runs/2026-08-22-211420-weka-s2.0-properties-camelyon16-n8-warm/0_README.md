# 2026-08-22-211420-weka-s2.0-properties-camelyon16-n8-warm

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** 2.0  ·  **Started (UTC):** 2026-08-22T21:14:23Z
...
```
env CONDA_PREFIX=/data/local-nvme/conda-envs/wsi-cucim-2604 /data/local-nvme/conda-envs/wsi-cucim-2604/bin/python /home/ec2-user/wsi-cloud/scripts/extract-slide-properties.py --concurrency 8 --output-dir /mnt/weka/cataloging/2.0/camelyon16/n8-warm --manifest /tmp/stage2-manifests/camelyon16.txt --latency-csv /tmp/stage2-manifests/camelyon16-n8-warm-latencies.csv 
```

## Why this run exists

Stage 2.0 cell 12/16: OpenSlide property extraction. Dataset=camelyon16 (399 slides), concurrency=8, cache arm=warm (cold: vm.drop_caches=3 with recorded acknowledgment; warm: unrecorded n=64 warmup pass immediately before). Single-pass full dataset via openslide-python + multiprocessing.Pool. Headline: 'cataloged 399 slides in X seconds at concurrency 8, warm'.
