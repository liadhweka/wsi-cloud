# 2026-08-16-060751-weka-s1.0a-seqw-bs64k-jobs16

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** 1.0a  ·  **Started (UTC):** 2026-08-16T06:07:54Z
...
```
fio --name=seqw-bs64k-jobs16 --directory=/mnt/weka/benchmarks/fio-scratch --rw=write --bs=64k --size=4G --numjobs=16 --iodepth=1 --ioengine=libaio --direct=1 --runtime=600 --ramp_time=60 --time_based --group_reporting --unlink=1 --output-format=json+ --status-interval=1 
```

## Why this run exists

Stage 1.0a cell 12/35: sequential write, bs=64k, 16 jobs, iodepth=1, libaio --direct=1, 600s steady + 60s ramp, --unlink=1 to keep scratch clean.
