# 2026-08-15-182852-weka-s0-probe-clientcap-seqr-bs4m-jobs16

**Filesystem:** weka (mounted at /mnt/weka)
**Stage:** 0  ·  **Started (UTC):** 2026-08-15T18:28:55Z
...
```
fio --name=clientcap --directory=/mnt/weka/benchmarks/fio-scratch --rw=read --bs=4M --size=10G --numjobs=16 --iodepth=8 --ioengine=libaio --direct=1 --runtime=480 --time_based --group_reporting --output-format=json+ 
```

## Why this run exists

DIAGNOSTIC PROBE, never quote: client-capability seq READ of the write-probe's 160 GiB (backend-RAM-resident, so drives are out of the picture), bs=4M numjobs=16 iodepth=8, 480s to observe any burst-credit decay. Decision support for memory item 22.
