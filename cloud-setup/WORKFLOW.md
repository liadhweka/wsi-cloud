...
| Every methodology decision, with its why | [`../runs/STAGES.md`](../runs/STAGES.md) — decision log **D1–D16** |
...
| How do I run or recover one cell? | [`../runs/README.md`](../runs/README.md) |
| What did the pre-deployment audit find? | [`AUDIT-REPORT.md`](AUDIT-REPORT.md) |
