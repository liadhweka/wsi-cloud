...
Write into `cloud-setup/env.sh` **yourself**: `FSX_TIER`, `FSX_CAPACITY_TIB`, `FSX_METADATA_IOPS`,
...
Then **stop.** Benchmarking is a separate handoff (`cloud-setup/handoff-cloud.md`) with its own gates, including
