...
log "    scripts/aggregate-sweep.py 'runs/2026-05-0*-s1.0b-seqr-*'"
log "    scripts/aggregate-sweep.py 'runs/2026-05-0*-s1.0c-randw-*'"
log "    scripts/aggregate-sweep.py 'runs/2026-05-0*-s1.0d-randr-*'"
