...
: "${CUFILE_ENV_PATH_JSON:?CUFILE_ENV_PATH_JSON is unset -- see docs/NAMING-AND-VARIABLES.md}"
...
case "$DATASET" in
  brca)
    ...
    MANIFEST=$REPO/scripts/manifests/tcga-brca-stage4a-subset.tsv
    COORDS_DIR=${FS_MOUNT}/tissue-detection/3.0/tcga-brca/n64/patches
    ;;
  cam16)
    RAWTIFF_DIR=${FS_MOUNT}/data/camelyon16-rawtiff
    MANIFEST=$REPO/scripts/manifests/camelyon16-stage4a-subset.tsv
