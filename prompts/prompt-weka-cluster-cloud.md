...
**Then edit `env.sh` directly** — do not ask the human to transcribe values you already have:
...
(`prompts/handoff-cloud.md`), and it has its own reading and its own gates.
